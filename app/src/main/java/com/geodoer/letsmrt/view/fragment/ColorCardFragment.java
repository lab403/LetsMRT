 ...
 * {@link ColorCardFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ColorCardFragment#newInstance} factory method to
...
public class ColorCardFragment extends Fragment {
    ...
    public static ColorCardFragment newInstance(String param1, String param2) {
        ColorCardFragment fragment = new ColorCardFragment();
    ...
    private void initCards() {
        ActionSetColorCard actionSetColorCard = new ActionSetColorCard(getActivity());

        mCardArrayAdapter mCardArrayAdapter =
                new mCardArrayAdapter(getActivity(),actionSetColorCard.getCards());
